...
export default function AppointmentsPage(){
    ...
    const {data, appointmentsData, getAllSubjects, getAllTutors, getCurrentUserFutureAppointments} = useFirestore();
    ...
    useEffect(() => {
        ...
        async function getAndSetFutureAppointments(){
            const currentUserFutureAppointments = await getCurrentUserFutureAppointments();
